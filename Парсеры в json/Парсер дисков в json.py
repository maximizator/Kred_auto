...
url = "https://z34.ru/xml/disk?h=65ee9f149fd78bb1c186ed11380cf06cd7dfd6b0"
имя_файла = "../Готовые json/Диски в json.json"
...
while True:
    try:
        ...
        # 3. Собираем шины ПО КОРОБКАМ <Диск>
        все_шины = []
        for коробка_шины in корень.findall(".//Диск"):
            шина = {}
